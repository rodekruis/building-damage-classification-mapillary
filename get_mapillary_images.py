...
@click.command()
@click.option('--start_time', default='2020-08-04', help='filter by date')
@click.option('--bbox', default='35.492308,33.883913,35.547162,33.918119', help='filter by bounding box [long_start, lat_start, long_end, lat_end]')
